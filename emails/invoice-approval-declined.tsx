import { COMPANY_URL, templateNoBraceVar, templateVar } from "./_config";
...
export default function InvoiceApprovalDeclined() {
  ...
  const filename = templateVar('approvalDeclinedFileName');
	...
	const invoiceNumberCondition = templateNoBraceVar("approvalDeclinedInvoiceNumber");
